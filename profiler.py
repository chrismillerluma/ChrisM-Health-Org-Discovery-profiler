...
st.set_page_config(page_title="Healthcare Profiler (CMS + Reviews + News + Website)", layout="wide")
...
api_key = st.text_input("Google Places API Key (optional):", type="password")
